...
class Thread(object):
  def __init__(self, ops):
    self._regs = collections.defaultdict(long)
    self._fpu_data = chr(0) * 512
    self._ops = ops
...
if __name__ == "__main__":
  ...
  code.store_bytes(0x1000, "\x55\x89\xE5\x51\x8B\x45\x08\x8A\x08\x88\x4D\xFF\x89\xEC\x5D\xC2\x00\x00")
